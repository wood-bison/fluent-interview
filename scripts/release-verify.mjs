...
if (dev) {
  ...
  run('question-coverage-backlog', 'pnpm', ['coverage:backlog:check'], {
    ...
    env: {
      PATH_COMPLETION_MANIFEST: path.join(labRoot, 'docs/manifests/path-completion-development-2026-08-27.json'),
      CAPABILITY_BINDING_MANIFEST: path.join(root, 'fluent-question-brain/docs/verification/G15-capability-binding-manifest-2026-08-28.json'),
      CAPABILITY_BINDING_REPORT: path.join(root, 'fluent-question-brain/docs/verification/G15-capability-binding-release-2026-08-28.json'),
