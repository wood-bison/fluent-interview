...
- Status: **PASS**
- Generated: 2026-08-28T07:59:33.958Z
...
- [x] pass: HTTP 200, status=pass, duration=329ms
- [x] go-pass: HTTP 200, status=pass, duration=11665ms
- [x] java-pass: HTTP 200, status=pass, duration=694ms
- [x] csharp-pass: HTTP 200, status=pass, duration=2204ms
- [x] postgres-pass: HTTP 200, status=pass, duration=781ms
- [x] test-failure: HTTP 200, status=fail, duration=438ms
- [x] compile-failure: HTTP 200, status=error, duration=216ms
- [x] timeout: HTTP 504, status=timeout, duration=n/a
- [x] trace-evidence-identity: trace 1953b3cb977504ba4575476cb2328f68 contains task.run with correlation, task and revision identity
