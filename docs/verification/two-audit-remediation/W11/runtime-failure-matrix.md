...
- Status: **PASS**
- Generated: 2026-08-28T00:52:49.766Z
...
- [x] go-pass: HTTP 200, status=pass, duration=11538ms
- [x] java-pass: HTTP 200, status=pass, duration=559ms
- [x] csharp-pass: HTTP 200, status=pass, duration=1856ms
- [x] postgres-pass: HTTP 200, status=pass, duration=715ms
- [x] test-failure: HTTP 200, status=fail, duration=214ms
- [x] compile-failure: HTTP 200, status=error, duration=201ms
- [x] timeout: HTTP 504, status=timeout, duration=n/a
- [x] trace-evidence-identity: trace 91a4285189e5fa55ea5e103f4adeeee4 contains task.run with correlation, task and revision identity
