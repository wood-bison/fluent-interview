...
- Status: **PASS**
- Generated: 2026-08-27T22:30:56.828Z
...
- [x] pass: HTTP 200, status=pass, duration=310ms
- [x] go-pass: HTTP 200, status=pass, duration=11674ms
- [x] java-pass: HTTP 200, status=pass, duration=653ms
- [x] csharp-pass: HTTP 200, status=pass, duration=1874ms
- [x] postgres-pass: HTTP 200, status=pass, duration=700ms
- [x] test-failure: HTTP 200, status=fail, duration=200ms
- [x] compile-failure: HTTP 200, status=error, duration=190ms
- [x] timeout: HTTP 504, status=timeout, duration=n/a
- [x] trace-evidence-identity: trace 2a51ac026314cac57e4340b40204cdc6 contains task.run with correlation, task and revision identity
