...
const bindingManifestPath = path.resolve(
  process.env.CAPABILITY_BINDING_MANIFEST ??
    path.join(root, 'fluent-question-brain/docs/verification/G14-capability-binding-manifest-2026-08-28.json'),
);
const bindingReportPath = path.resolve(
  process.env.CAPABILITY_BINDING_REPORT ??
    path.join(root, 'fluent-question-brain/docs/verification/G14-capability-binding-release-2026-08-28.json'),
);
