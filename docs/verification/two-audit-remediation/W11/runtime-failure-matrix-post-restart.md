...
- Status: **PASS**
- Generated: 2026-08-27T21:21:14.755Z
...
- [x] pass: HTTP 200, status=pass, duration=211ms
- [x] go-pass: HTTP 200, status=pass, duration=11301ms
- [x] java-pass: HTTP 200, status=pass, duration=614ms
- [x] csharp-pass: HTTP 200, status=pass, duration=1809ms
- [x] postgres-pass: HTTP 200, status=pass, duration=679ms
- [x] test-failure: HTTP 200, status=fail, duration=193ms
- [x] compile-failure: HTTP 200, status=error, duration=183ms
- [x] timeout: HTTP 504, status=timeout, duration=n/a
- [x] trace-evidence-identity: trace 16d76259e84af49047826a9288bca44b contains task.run with correlation, task and revision identity
