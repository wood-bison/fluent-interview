...
`fluent-engineering-lab@af0ccf8`. Реализация включает общую контрактную state
...
| M2 | `ACTIVE` | Lab | 2026-08-25 | Lab `af0ccf8` | [`M2/baseline.json`](verification/capability-closure/M2/baseline.json) | independent review pending |
