...
- Status: **PASS**
- Generated: 2026-08-27T23:06:35.202Z
...
- [x] pass: HTTP 200, status=pass, duration=206ms
- [x] go-pass: HTTP 200, status=pass, duration=11809ms
- [x] java-pass: HTTP 200, status=pass, duration=659ms
- [x] csharp-pass: HTTP 200, status=pass, duration=1961ms
- [x] postgres-pass: HTTP 200, status=pass, duration=730ms
...
- [x] trace-evidence-identity: trace 956611a2f9bdf0c83eab0b038afbd292 contains task.run with correlation, task and revision identity
