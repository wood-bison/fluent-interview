...
`fluent-engineering-lab@a01b44f`. Реализация включает общую контрактную state
...
| M2 | `ACTIVE` | Lab | 2026-08-25 | Lab `a01b44f` | [`M2/baseline.json`](verification/capability-closure/M2/baseline.json) | independent review pending |
