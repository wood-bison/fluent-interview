...
- Status: **PASS**
- Generated: 2026-08-27T23:21:14.276Z
...
- [x] pass: HTTP 200, status=pass, duration=223ms
- [x] go-pass: HTTP 200, status=pass, duration=11919ms
- [x] java-pass: HTTP 200, status=pass, duration=720ms
- [x] csharp-pass: HTTP 200, status=pass, duration=1884ms
- [x] postgres-pass: HTTP 200, status=pass, duration=703ms
- [x] test-failure: HTTP 200, status=fail, duration=199ms
- [x] compile-failure: HTTP 200, status=error, duration=195ms
- [x] timeout: HTTP 504, status=timeout, duration=n/a
- [x] trace-evidence-identity: trace d69efb8dd53ebaf970ca0412bc330cb8 contains task.run with correlation, task and revision identity
