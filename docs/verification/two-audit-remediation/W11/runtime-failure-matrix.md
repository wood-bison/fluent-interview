...
- Status: **PASS**
- Generated: 2026-08-27T22:24:20.316Z
...
- [x] pass: HTTP 200, status=pass, duration=225ms
- [x] go-pass: HTTP 200, status=pass, duration=11594ms
- [x] java-pass: HTTP 200, status=pass, duration=580ms
- [x] csharp-pass: HTTP 200, status=pass, duration=1906ms
- [x] postgres-pass: HTTP 200, status=pass, duration=703ms
- [x] test-failure: HTTP 200, status=fail, duration=204ms
- [x] compile-failure: HTTP 200, status=error, duration=197ms
- [x] timeout: HTTP 504, status=timeout, duration=n/a
- [x] trace-evidence-identity: trace 693cb0e98d817d8f4b71fafe92ecb7be contains task.run with correlation, task and revision identity
