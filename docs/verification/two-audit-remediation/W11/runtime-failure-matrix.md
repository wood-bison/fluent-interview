...
- Status: **PASS**
- Generated: 2026-08-28T11:27:42.814Z
...
- [x] pass: HTTP 200, status=pass, duration=275ms
- [x] go-pass: HTTP 200, status=pass, duration=11867ms
- [x] java-pass: HTTP 200, status=pass, duration=834ms
- [x] csharp-pass: HTTP 200, status=pass, duration=2143ms
- [x] postgres-pass: HTTP 200, status=pass, duration=765ms
- [x] test-failure: HTTP 200, status=fail, duration=210ms
- [x] compile-failure: HTTP 200, status=error, duration=206ms
- [x] timeout: HTTP 504, status=timeout, duration=n/a
- [x] trace-evidence-identity: trace a913850a24682c5af889d0d674c974ff contains task.run with correlation, task and revision identity
